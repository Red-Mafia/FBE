...
def banner():
    _logo_line_1_ = ('%s█████  ██  █████  ███████'%(O))
    _logo_line_2_ = ('%s██   ██ ██ ██   ██    ███  %s©  %s<  /  ╔═══════════════════════╗'%(O,P,O))
    _logo_line_3_ = ('%s██████  ██ ███████   ███   %sCoded By RUAZKHAN  %s║'%(O,P,O))
    _logo_line_4_ = ('%s██   ██ ██ ██   ██  ███    %s• RED-MAFIA TEAM              %s║'%(O,P,O))
    _logo_line_5_ = ('%s██   ██ ██ ██   ██ ███████ %s/____/   ╚═══════════════════════╝'%(P,O))
...
def menu_log():
    ...
    if pmu in ['']:jalan('%s╚══[%s!%s] %sIsi Yang Benar'%(M,P,M,P));menu_log()
        ...
        elif pf in ['1','01','001','a']:os.system('xdg-_dapunta_dapunta_ https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi');_cici_dapunta_('%s╚══[ %sKembali %s]%s'%(O,P,O,P));menu_log()
        elif pf in ['2','02','002','b']:os.system('xdg-_dapunta_dapunta_ https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi');_cici_dapunta_('%s╚══[ %sKembali %s]%s'%(O,P,O,P));menu_log()
        elif pf in ['3','03','003','c']:os.system('xdg-_dapunta_dapunta_ https://chat.whatsapp.com/KmWJuOGRgVdHrDpMAFaOVi');tutor_target();_cici_dapunta_('%s╚══[ %sKembali %s]%s'%(O,P,O,P));menu_log()
